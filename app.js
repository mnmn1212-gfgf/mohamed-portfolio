...
const i18n = {
  en: {
    ...
    visits_label: "Visits",
    visits_hint: "Live counter",

    rating_title: "Rate this Portfolio",
    rating_desc: "Your feedback helps me improve. One rating per device.",
    rating_votes: "votes",
    rating_hint: "Tap a star to rate",
    rating_admin: "Open Dashboard"
  },
  ...
  ar: {
    ...
    voice_title: "صوت تعريفي",

    visits_label: "الزيارات",
    visits_hint: "عداد مباشر",

    rating_title: "قيّم البورتفوليو",
    rating_desc: "تقييمك يساعدني أطور. تقييم واحد لكل جهاز.",
    rating_votes: "تقييم",
    rating_hint: "اضغط على نجمة للتقييم",
    rating_admin: "لوحة التحكم"
  }
};
...
/* =========================================================
   ✅ VOICE PLAYER (Waveform fixed: full width + full react)
========================================================= */
(function () {
  ...
  function initWebAudio() {
    ...
    analyser.fftSize = 2048; // more detail
  ...
  async function safePlay() {
    ...
    try {
      ...
      alert("الصوت لم يعمل. تأكد أن assets/voice.mp3 موجود، ويفضل تشغيل الموقع بسيرفر (Netlify).");
    }
  }
  ...
  // ✅ canvas resize (once on resize, not every frame)
  let W = 0, H = 0, DPR = 1;
  ...
  function draw() {
    ...
    const barW = (W - totalGap) / bars; // ✅ reaches the end
    const mid = H * 0.5;
    const maxAmp = H * 0.42;
